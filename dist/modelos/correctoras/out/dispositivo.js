...
exports.IDispositivoCorrectoraDTOSwagger = exports.IDispositivoCorrectoraDTOValidation = void 0;
const joi_1 = __importDefault(require("joi"));
const joi_to_swagger_1 = __importDefault(require("joi-to-swagger"));
const metadatos_1 = require("../../shared/metadatos");
const reporte_1 = require("./reporte");
exports.IDispositivoCorrectoraDTOValidation = joi_1.default.object({
    // Base
